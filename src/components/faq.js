...
const faqs = [
  ...
  { q: 'واش 149dh ماشي بزاف؟', a: 'حصة وحدة خاصة فمركز كتكلف 200-400dh. هنا عندك 33 ساعة ديال المحتوى المنظم بـ 149dh فقط — أقل من ثمن عشاء فمطعم.' },
  ...
  { q: 'ما عنديش الوقت بزاف — واش نقدر؟', a: 'عندك وصول مدى الحياة. 30 دقيقة فالنهار كافية. بهاد الإيقاع تقدر تكمل الكورسات كاملين فـ 2-3 أشهر.' },
    ...
    <section id="faq" className="py-24" dir="rtl">
      <div className="max-w-3xl mx-auto px-6">
        <div className="text-center mb-16">
          <span className="text-[#FFCC00] text-sm font-black tracking-widest uppercase">FAQ</span>
