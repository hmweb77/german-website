  ...
  return (
    <section className="py-32 relative overflow-hidden text-center" dir="rtl">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <span className="text-[#FFCC00] text-sm font-black tracking-widest uppercase">DON&apos;T WAIT</span>
...
export function Footer() {
  return (
    <footer className="py-12 border-t border-[#21262d] text-center text-gray-600 text-sm">
