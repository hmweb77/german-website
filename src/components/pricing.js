      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-20">
          ...
          <div className="bg-[#0d1117] border border-[#21262d] p-10 rounded-3xl flex flex-col">
            ...
            <p className="text-gray-200 text-sm mb-8">مستوى واحد فقط، مناسب إلا بغيت تجرب</p>
            <div className="text-4xl font-black text-white mb-8">79 درهم</div>
            <div className="space-y-4 mb-10 flex-1">
              <div className="flex items-center gap-3 text-gray-200 text-sm"><Check size={18} className="text-green-500" /> مستوى واحد كامل</div>
              <div className="flex items-center gap-3 text-gray-200 text-sm"><Check size={18} className="text-green-500" /> وصول مدى الحياة</div>
              <div className="flex items-center gap-3 text-gray-200 text-sm"><Check size={18} className="text-green-500" /> شهادة إتمام</div>
              <div className="flex items-center gap-3 text-gray-200 text-sm opacity-50"><span className="text-red-500">✗</span> باقي المستويات</div>
              <div className="flex items-center gap-3 text-gray-200 text-sm opacity-50"><span className="text-red-500">✗</span> التحديثات المستقبلية</div>
            </div>
          ...
          >
            ...
            <p className="text-gray-200 text-sm mb-8">جميع الكورسات من A1.1 حتى A2.2، أحسن قيمة</p>
            <div className="mb-4">
              <span className="text-gray-100  text-2xl relative inline-block">
                316dh
                <span
